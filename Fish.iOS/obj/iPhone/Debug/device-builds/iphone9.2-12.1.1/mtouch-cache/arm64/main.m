...
extern void *mono_aot_module_Fish_iOS_info;
...
extern void *mono_aot_module_Fish_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_Urho_info;

void xamarin_register_modules_impl ()
{
	mono_aot_register_module (mono_aot_module_Fish_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Fish_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_Urho_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_open_and_register ("Urho.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Fish.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
